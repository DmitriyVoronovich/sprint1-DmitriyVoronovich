...
export const Regulations = () => (
  <div className='terms'>
    <ol className='terms_list'>
      ...
      <ol>
        <li className='terms_list_item_one'>
      ...
      <ol>
        ...
        <ol>
          <li className='terms_list_item_one terms_list_item_two'>
        ...
        <li className='terms_list_item_one'>
          2.3 Но независимые государства, которые представляют собой яркий пример континентально-европейского типа
          политической культуры, будут объединены в целые кластеры себе подобных.
        </li>
      </ol>
      <li className='terms_list_item'>
      ...
      <ol>
        ...
        <ol>
          ...
          <ol>
            <li className='terms_list_item_one terms_list_item_three'>
